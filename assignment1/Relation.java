...
public class Relation{
  ...
  public static void main(String[] args){
		...
		RB.join(product, x -> RB.tuples[x[0]][0].equals(product.tuples[x[1]][1])).showRelation();
		// TODO: Projection for part (B)

		System.out.println("---------------------------------------------------------------------\nPart C:\n");
		Relation manufacturerB = product.select(r -> product.tuples[r][0].equals("B"));
		manufacturerB.join(laptop, x -> manufacturerB.tuples[x[0]][1].equals(laptop.tuples[x[1]][0]));
		// TODO: finish part (C)
